...
const AMAZON_HelpIntent_Handler = {
  ...
  handle(handlerInput) {
    ...
    if (supportsAPL(handlerInput)) {
      ...
      return responseBuilder.speak(say).reprompt(sp.reprompt).getResponse();
    }
  },
};
...
const askAboutVitamin_Handler = {
  canHandle(handlerInput) {
    ...
    return (
      request.type === "IntentRequest" &&
      request.intent.name === "askAboutVitamin"
    );
  },
  handle(handlerInput) {
    const request = handlerInput.requestEnvelope.request;
    ...
    if (slotValues.VitaminsList.heardAs) {
      slotStatus +=
        " slot VitaminsList was heard as " +
        slotValues.VitaminsList.heardAs +
        ". ";
    } else {
    ...
    if (slotValues.VitaminsList.ERstatus === "ER_SUCCESS_MATCH") {
      slotStatus += "a valid ";
      if (
        slotValues.VitaminsList.resolved !== slotValues.VitaminsList.heardAs
      ) {
    ...
    if (slotValues.VitaminsList.ERstatus === "ER_SUCCESS_NO_MATCH") {
      ...
      console.log(
        '***** consider adding "' +
          slotValues.VitaminsList.heardAs +
          '" to the custom slot type used by slot VitaminsList! '
      );
    }

    if (
      slotValues.VitaminsList.ERstatus === "ER_SUCCESS_NO_MATCH" ||
      !slotValues.VitaminsList.heardAs
    ) {
      slotStatus +=
        "A few valid values are, " +
        sayArray(getExampleSlotValues("askAboutVitamin", "VitaminsList"), "or");
    }
      ...
      bodyTemplate3Data: {
        ...
        backgroundImage: {
          ...
          sources: [
            {
              url:
                "https://s3.amazonaws.com/vitamin-guide/background-body-guide.png",
              size: "small",
              widthPixels: 0,
              heightPixels: 0,
            },
        ...
        logoUrl: "https://s3.amazonaws.com/human-guide-apl/ok+2.png",
        hintText: 'Try, "Tell me about Brain"',
      },
    };
...
const DisplayImg2 = {
  title: "Starry Sky",
  url: "https://s3.amazonaws.com/vitamin-guide/background-body-guide.png",
};
